...
<div class="container">
	...
	<h1>Nieuw account</h1>
	<form class="form-horizontal" action="?admin=nieuw_account" method="post">
		<div class="form-group">
			<label for="Gebruikersnaam" class="col-sm-2 control-label">Gebruikersnaam</label>
			<div class="col-sm-3"><input name="username" class="form-control" type="text" value=""></div>
		</div>
		<div class="form-group">
			<label for="E-mailadres" class="col-sm-2 control-label">E-mailadres</label>
			<div class="col-sm-3"><input name="email" class="form-control" type="text" value=""></div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-4"><button type="submit" name="submit" class="btn btn-success">Nieuw account!</button></div>
		</div>
	</form>	
</div>