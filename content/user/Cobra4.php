...
<div class="span12 main-column">
	<h1><strong>Cobra4</strong> <small>168091</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Cobra4?></div>
		</div>
        
		<div class="span6">
            <h4>6 februari 2007</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/168091" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1702251" target="_blank">26 aug 2011</a></td>
		  <td>heden</td>
		  <td><?=$uCobra4_i1;?> dagen</td>
		</tr>
		<tr class="success">
		  <td><?=++$t?></td>
		...
		<tr>
		  ...
		  <td><code><?=$uCobra4_total;?> dagen</code>
		  </td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 250px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'DEF', new Date(2011, 07, 26), new Date() ],
					[ '2', 'C&H', new Date(2012, 01, 05), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Cobra4', new Date(2007, 01, 06), new Date() ],
					[ '1', 'DEF', new Date(2011, 07, 26), new Date() ],
					[ '2', 'C&H', new Date(2012, 01, 05), new Date() ]]);
