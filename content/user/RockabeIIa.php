...
<div class="span12 main-column">
	<h1><strong>RockabeIIa</strong> <small>190853</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_RockabeIIa?></div>
		</div>
        
		<div class="span6">
            <h4>6 september 2007</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/190853" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1259354" target="_blank">24 feb 2009</a></td>
		  <td>heden</td>
		  <td><?=$uRockabeIIa_i1;?> dagen</td>
		</tr>
		<tr class="success">
		  <td><?=++$t?></td>
		  <td><strong><?=$CRE?></strong></td>
		  <td><a href="http://forum.fok.nl/topic/1710429" target="_blank">14 sep 2011</a></td>
		  <td>heden</td>
		  <td><?=$uRockabeIIa_i2;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uRockabeIIa_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 240px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'OUD', new Date(2009, 01, 24), new Date() ],
					[ '2', 'CRE', new Date(2011, 08, 14), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'RockabeIIa', new Date(2007, 08, 06), new Date() ],
					[ '1', 'OUD', new Date(2009, 01, 24), new Date() ],
					[ '2', 'CRE', new Date(2011, 08, 14), new Date() ]]);
