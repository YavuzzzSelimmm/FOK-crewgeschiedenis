...
<div class="span12 main-column">
	<h1><strong>Pharkus</strong> <small>54263</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Pharkus?></div>
		</div>
        
		<div class="span6">
            <h4>29 april 2003</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/54263" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1737443" target="_blank">13 nov 2011</a></td>
		  <td>heden</td>
		  <td><?=$uPharkus_i1;?> dagen</td>
		</tr>
		<tr class="success">
		  <td><?=++$t?></td>
		  <td><strong>Forum Admin</strong></td>
		  <td><a href="http://forum.fok.nl/topic/1998404" target="_blank">20 jul 2013</a></td>
		  <td>heden</td>
		  <td><?=$uPharkus_i2;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uPharkus_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 250px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'KLB', new Date(2011, 10, 13), new Date() ],
					[ 'FA', 'Forum Admin', new Date(2013, 06, 20), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Pharkus', new Date(2003, 03, 29), new Date() ],
					[ '1', 'KLB', new Date(2011, 10, 13), new Date() ],
					[ 'FA', 'Forum Admin', new Date(2013, 06, 20), new Date() ]]);
