...
<div class="span12 main-column">
	<h1><strong>JDude</strong> <small>74976</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_JDude?></div>
		</div>
        
		<div class="span6">
            <h4>21 november 2003</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/74976" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr>
		  <td><?=++$t?></td>
		  <td><?=$SES?></td>
		  <td><a href="http://forum.fok.nl/topic/714409" target="_blank">14 jun 2005</a></td>
		  <td><a href="http://forum.fok.nl/topic/799500" target="_blank">04 jan 2006</a></td>
		  <td><?=$uJDude_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uJDude_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'SES', new Date(2005, 05, 14), new Date(2005, 12, 04) ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'JDude', new Date(2003, 10, 21), new Date() ],
					[ '1', 'SES', new Date(2005, 05, 14), new Date(2005, 12, 04) ]]);
