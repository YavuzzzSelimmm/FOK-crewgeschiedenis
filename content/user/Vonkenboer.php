...
<div class="span12 main-column">
	<h1><strong>Vonkenboer</strong> <small>92034</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Vonkenboer?></div>
		</div>
        
		<div class="span6">
            <h4>13 april 2004</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/92034" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		...
		<tr>
		  ...
		  <td><code><?=$uVonkenboer_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'K&W', new Date(2008, 02, 07), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Vonkenboer', new Date(2004, 03, 13), new Date() ],
					[ '1', 'K&W', new Date(2008, 02, 07), new Date() ]]);
