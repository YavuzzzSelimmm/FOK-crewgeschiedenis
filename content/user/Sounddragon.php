...
<div class="span12 main-column">
	<h1><strong>Sounddragon</strong> <small>88754</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Sounddragon?></div>
		</div>
        
		<div class="span6">
            <h4>14 maart 2004</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/88754" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  <td><?=++$t?></td>
		  <td><?=$PTA?></td>
		  <td><a href="http://forum.fok.nl/topic/1455167" target="_blank">09 mei 2010</a></td>
		  <td>heden</td>
		  <td><?=$uSounddragon_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uSounddragon_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'PTA', new Date(2010, 04, 09), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Sounddragon', new Date(2004, 02, 14), new Date() ],
					[ '1', 'PTA', new Date(2010, 04, 09), new Date() ]]);
