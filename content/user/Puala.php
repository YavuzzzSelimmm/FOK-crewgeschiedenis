...
<div class="span12 main-column">
	<h1><strong>Puala</strong> <small>228500</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Puala?></div>
		</div>
        
		<div class="span6">
            <h4>16 september 2008</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/228500" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  <td><?=++$t?></td>
		  <td><b><?=$FOT?></b></td>
		  <td><a href="http://forum.fok.nl/topic/1963251" target="_blank">25 apr 2013</a></td>
		  <td>heden</td>
		  <td><?=$uPuala_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uPuala_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'FOT', new Date(2013, 03, 25), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Puala', new Date(2008, 08, 16), new Date() ],
					[ '1', 'FOT', new Date(2013, 03, 25), new Date() ]]);
