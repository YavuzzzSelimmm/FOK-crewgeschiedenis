...
<div class="span12 main-column">
	<h1><strong>Tamashii</strong> <small>193540</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Tamashii?></div>
		</div>
        
		<div class="span6">
            <h4>6 oktober 2007</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/193540" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  <td><?=++$t?></td>
		  <td><b><?=$SEX?></b></td>
		  <td><a href="http://forum.fok.nl/topic/1809153" target="_blank">27 apr 2012</a></td>
		  <td>heden</td>
		  <td><?=$uTamashii_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uTamashii_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'SEX', new Date(2012, 03, 27), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Tamashii', new Date(2007, 09, 06), new Date() ],
					[ '1', 'SEX', new Date(2012, 03, 27), new Date() ]]);
