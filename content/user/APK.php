...
<div class="span12 main-column">
	<h1><strong>APK</strong> <small>6941</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_APK?></div>
		</div>
        
		<div class="span6">
            <h4>26 oktober 2000</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/6941" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  <td><?=++$t?></td>
		  <td><b><?=$UVT;?></b></td>
		  <td><a href="http://forum.fok.nl/topic/1769404" target="_blank">24 jan 2012</a></td>
		  <td>heden</td>
		  <td><?=$uAPK_i1;?> dagen</td>
		</tr>
		<tr>
		  ...
		  <td><code><?=$uAPK_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'UVT', new Date(2011, 12, 24), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'APK', new Date(2000, 09, 26), new Date() ],
					[ '1', 'UVT', new Date(2011, 12, 24), new Date() ]]);
