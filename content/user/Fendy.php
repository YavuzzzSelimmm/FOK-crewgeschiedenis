...
<div class="span12 main-column">
	<h1><strong>Fendy</strong> <small>19529</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Fendy?></div>
		</div>
        
		<div class="span6">
            <h4>8 december 2001</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/19529" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  <td><?=++$t?></td>
		  <td><b><?=$UVT;?></b></td>
		  <td><a href="http://forum.fok.nl/topic/1529739" target="_blank">16 sep 2010</a></td>
		  <td>heden</td>
		  <td><?=$uFendy_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uFendy_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'UVT', new Date(2010, 08, 16), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Fendy', new Date(2001, 11, 08), new Date() ],
					[ '1', 'UVT', new Date(2010, 08, 16), new Date() ]]);
