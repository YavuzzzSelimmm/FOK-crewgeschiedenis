...
<div class="span12 main-column">
	<h1><strong>debuurvrouw</strong> <small>131983</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_debuurvrouw?></div>
		</div>
        
		<div class="span6">
            <h4>5 oktober 2005</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/131983" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1885386" target="_blank">22 okt 2012</a></td>
		  <td>heden</td>
		  <td><?=$udebuurvrouw_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$udebuurvrouw_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'OUD', new Date(2012, 09, 22), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'debuurvrouw', new Date(2005, 09, 05), new Date() ],
					[ '1', 'OUD', new Date(2012, 09, 22), new Date() ]]);
