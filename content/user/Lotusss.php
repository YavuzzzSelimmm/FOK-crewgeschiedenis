...
<div class="span12 main-column">
	<h1><strong>Lotusss</strong> <small>88561</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Lotusss?></div>
		</div>
        
		<div class="span6">
            <h4>12 maart 2004</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/88561" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr>
		  ...
		  <td><a href="http://forum.fok.nl/topic/1999536" target="_blank">23 jul 2013</a></td>
		  <td><?=$uLotusss_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uLotusss_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'DEF', new Date(2010, 10, 08), new Date(2013, 06, 23) ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Lotusss', new Date(2004, 02, 12), new Date() ],
					[ '1', 'DEF', new Date(2010, 10, 08), new Date(2013, 06, 23) ]]);
