...
<div class="span12 main-column">
	<h1><strong>Bosbeetle</strong> <small>27682</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Bosbeetle?></div>
		</div>
        
		<div class="span6">
            <h4>6 mei 2002</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/27682" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1736562" target="_blank">11 nov 2011</a></td>
		  <td>heden</td>
		  <td><?=$uBosbeetle_i1;?> dagen</td>
		</tr>
		<tr>
		  <td><?=++$t?></td>
		  <td><?=$LWL?></td>
		...
		<tr>
		  ...
		  <td><code><?=$uBosbeetle_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1826041" target="_blank">05 jun 2012</a></td>
		  <td>heden</td>
		  <td><?=$uBosbeetle_fi1;?> dagen</td>
		</tr>
	  </tbody>
	</table>
		<div class="text-divider5"><span></span></div>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 290px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'MUZ', new Date(2011, 10, 11), new Date() ],
					[ 'PR', 'PR', new Date(2012, 05, 05), new Date() ],
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Bosbeetle', new Date(2002, 04, 06), new Date() ],
					[ '1', 'MUZ', new Date(2011, 10, 11), new Date() ],
					[ 'PR', 'PR', new Date(2012, 05, 05), new Date() ],
					[ '2', 'LWL', new Date(2012, 05, 19), new Date(2012, 07, 27) ]]);
