...
<div class="span12 main-column">
	<h1><strong>HeaN82</strong> <small>279246</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_HeaN82?></div>
		</div>
        
		<div class="span6">
            <h4>9 november 2009</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/279246" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1978673" target="_blank">31 mei 2013</a></td>
		  <td>heden</td>
		  <td><?=$uHeaN82_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uHeaN82_total?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'ONZ', new Date(2013, 04, 31), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'HeaN82', new Date(2009, 10, 09), new Date() ],
					[ '1', 'ONZ', new Date(2013, 04, 31), new Date() ]]);
