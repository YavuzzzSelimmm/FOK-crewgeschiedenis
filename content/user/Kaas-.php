...
<div class="span12 main-column">
	<h1><strong>Kaas-</strong> <small>289170</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Kaas?></div>
		</div>
        
		<div class="span6">
            <h4>27 januari 2010</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/289170" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  <td><?=++$t?></td>
		  <td><strong><?=$AEX?></strong></td>
		  <td><a href="http://forum.fok.nl/topic/1807968" target="_blank">24 apr 2012</a></td>
		  <td>heden</td>
		  <td><?=$uKaas_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uKaas_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'AEX', new Date(2012, 03, 23), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Kaas-', new Date(2009, 12, 27), new Date() ],
					[ '1', 'AEX', new Date(2012, 03, 23), new Date() ]]);
