...
<div class="span12 main-column">
	<h1><strong>SaintOfKillers</strong> <small>67640</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_SaintOfKillers?></div>
		</div>
        
		<div class="span6">
            <h4>12 september 2003</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/67640" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/747415" target="_blank">31 aug 2005</a></td>
		  <td>heden</td>
		  <td><?=$uSaintOfKillers_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uSaintOfKillers_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'TV', new Date(2005, 07, 31), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'SaintOfKillers', new Date(2003, 08, 12), new Date() ],
					[ '1', 'TV', new Date(2005, 07, 31), new Date() ]]);
