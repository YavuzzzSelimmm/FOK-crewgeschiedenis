...
<div class="span12 main-column">
	<h1><strong>___</strong> <small>___</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_+++?></div>
		</div>
        
		<div class="span6">
            <h4>___</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
