...
<div class="span12 main-column">
	<h1><strong>Maharbal</strong> <small>128002</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Maharbal?></div>
		</div>
        
		<div class="span6">
            <h4>20 augustus 2005</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/128002" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  <td><?=++$t?></td>
		  <td><b><?=$WGR?></b></td>
		  <td><a href="http://forum.fok.nl/topic/1907540" target="_blank">17 dec 2012</a></td>
		  <td>heden</td>
		  <td><?=$uMaharbal_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uMaharbal_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'WGR', new Date(2012, 11, 17), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Maharbal', new Date(2005, 07, 20), new Date() ],
					[ '1', 'WGR', new Date(2012, 11, 17), new Date() ]]);
