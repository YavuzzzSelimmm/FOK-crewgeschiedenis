...
<div class="span12 main-column">
	<h1><strong>iBenny</strong> <small>255123</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_iBenny?></div>
		</div>
        
		<div class="span6">
            <h4>8 mei 2009</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/255123" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1481465" target="_blank">22 juni 2010</a></td>
		  <td>heden</td>
		  <td><?=$uiBenny_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uiBenny_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 240px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'TAL', new Date(2010, 05, 22), new Date() ],
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'iBenny', new Date(2009, 04, 08), new Date() ],
					[ '1', 'TAL', new Date(2010, 05, 22), new Date() ],
					[ 'RFP', 'Redactie FP', new Date(2012, 07, 02), new Date() ]]);
