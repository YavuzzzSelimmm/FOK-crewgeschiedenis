...
<div class="span12 main-column">
	<h1><strong>Ole</strong> <small>22592</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Ole?></div>
		</div>
        
		<div class="span6">
            <h4>10 februari 2002</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/22592" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1625829" target="_blank">21 mar 2011</a></td>
		  <td>heden</td>
		  <td><?=$uOle_i1;?> dagen</td>
		</tr>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1668313" target="_blank">15 jun 2011</a></td>
		  <td>heden</td>
		  <td><?=$uOle_i2;?> dagen</td>
		</tr>
		<tr>
		  ...
		  <td><code><?=$uOle_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 240px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'SHO', new Date(2011, 02, 21), new Date() ],
					[ '2', 'B&H', new Date(2011, 05, 15), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Ole', new Date(2002, 01, 10), new Date() ],
					[ '1', 'SHO', new Date(2011, 02, 21), new Date() ],
					[ '2', 'B&H', new Date(2011, 05, 15), new Date() ]]);
