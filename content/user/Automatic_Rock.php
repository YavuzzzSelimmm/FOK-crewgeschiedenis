...
<div class="span12 main-column">
	<h1><strong>Automatic_Rock</strong> <small>36763</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Automatic_Rock?></div>
		</div>
        
		<div class="span6">
            <h4>23 september 2002</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/36763" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/649868" target="_blank">19 dec 2004</a></td>
		  <td>heden</td>
		  <td><?=$uAutomatic_Rock_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uAutomatic_Rock_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'TTK', new Date(2004, 11, 19), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Automatic_Rock', new Date(2002, 08, 23), new Date() ],
					[ '1', 'TTK', new Date(2004, 11, 19), new Date() ]]);
