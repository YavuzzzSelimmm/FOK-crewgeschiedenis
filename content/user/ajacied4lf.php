...
<div class="span12 main-column">
	<h1><strong>ajacied4lf</strong> <small>303556</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_ajacied4lf?></div>
		</div>
        
		<div class="span6">
            <h4>17 mei 2010</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/303556" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1980899" target="_blank">05 jun 2013</a></td>
		  <td>heden</td>
		  <td><?=$uajacied4lf_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uajacied4lf_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'BNW', new Date(2013, 05, 05), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'ajacied4lf', new Date(2010, 04, 17), new Date() ],
					[ '1', 'BNW', new Date(2013, 05, 05), new Date() ]]);
