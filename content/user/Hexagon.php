...
<div class="span12 main-column">
	<h1><strong>Hexagon</strong> <small>75043</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Hexagon?></div>
		</div>
        
		<div class="span6">
            <h4>22 november 2003</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/75043" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1991497" target="_blank">02 jul 2013</a></td>
		  <td>heden</td>
		  <td><?=$uHexagon_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uHexagon_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'POL', new Date(2013, 06, 02), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Hexagon', new Date(2003, 10, 22), new Date() ],
					[ '1', 'POL', new Date(2013, 06, 02), new Date() ]]);
