...
<div class="span12 main-column">
	<h1><strong>Ml-etje</strong> <small>216210</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Mletje?></div>
		</div>
        
		<div class="span6">
            <h4>25 mei 2008</h4>
            <p class="experience"><strong><a href="h	ttp://forum.fok.nl/user/profile/216210" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  <td><?=++$t?></td>
		  <td><b><?=$KW?></b></td>
		  <td><a href="http://forum.fok.nl/topic/1433259" target="_blank">28 mar 2010</a></td>
		  <td>heden</td>
		  <td><?=$uMletje_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uMletje_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'K&W', new Date(2010, 02, 28), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Ml-etje', new Date(2008, 04, 25), new Date() ],
					[ '1', 'K&W', new Date(2010, 02, 28), new Date() ]]);
