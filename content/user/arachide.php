...
<div class="span12 main-column">
	<h1><strong>arachide.</strong> <small>364404</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_arachide?></div>
		</div>
        
		<div class="span6">
            <h4>1 januari 2012</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/364404" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr>
		  ...
		  <td><a href="http://forum.fok.nl/topic/2004468" target="_blank">04 aug 2013</a></td>
		  <td><?=$uarachide_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uarachide_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'JNG', new Date(2013, 03, 21), new Date(2013, 07, 04) ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'arachide.', new Date(2009, 10, 09), new Date() ],
					[ '1', 'JNG', new Date(2013, 03, 21), new Date(2013, 07, 04) ]]);
