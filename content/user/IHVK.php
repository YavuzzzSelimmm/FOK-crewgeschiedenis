...
<div class="span12 main-column">
	<h1><strong>IHVK</strong> <small>139371</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_IHVK?></div>
		</div>
        
		<div class="span6">
            <h4>18 januari 2006</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/139371" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr>
		  <td><?=++$t?></td>
		  <td><?=$CH?></td>
		  <td><a href="http://forum.fok.nl/topic/1230963" target="_blank">16 dec 2008</a></td>
		  <td><a href="http://forum.fok.nl/topic/1478552" target="_blank">18 jun 2010</a></td>
		  <td><?=$uIHVK_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uIHVK_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'C&H', new Date(2008, 11, 16), new Date(2010, 05, 18) ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'IHVK', new Date(2005, 12, 18), new Date() ],
					[ '1', 'C&H', new Date(2008, 11, 16), new Date(2010, 05, 18) ]]);
