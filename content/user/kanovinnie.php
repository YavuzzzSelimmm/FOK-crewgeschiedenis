...
<div class="span12 main-column">
	<h1><strong>kanovinnie</strong> <small>84430</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_kanovinnie?></div>
		</div>
        
		<div class="span6">
            <h4>9 februari 2004</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/84430" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1592061/" target="_blank">15 jan 2011</a></td>
		  <td>heden</td>
		  <td><?=$ukanovinnie_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$ukanovinnie_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 240px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'GC', new Date(2010, 12, 15), new Date() ],
					[ 'Fg', 'FOK!fotograaf', new Date(2011, 06, 07), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'kanovinnie', new Date(2004, 01, 09), new Date() ],
					[ '1', 'GC', new Date(2010, 12, 15), new Date() ],
					[ 'Fg', 'FOK!fotograaf', new Date(2011, 06, 07), new Date() ]]);
