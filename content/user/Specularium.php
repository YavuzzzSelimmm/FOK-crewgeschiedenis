...
<div class="span12 main-column">
	<h1><strong>Specularium</strong> <small>232445</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Specularium?></div>
		</div>
        
		<div class="span6">
            <h4>22 oktober 2008</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/232445" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  <td><?=++$t?></td>
		  <td><?=$NWS?></td>
		  <td><a href="http://forum.fok.nl/topic/2009242" target="_blank">16 aug 2013</a></td>
		  <td>heden</td>
		  <td><?=$uSpecularium_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uSpecularium_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'NWS', new Date(2013, 07, 16), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Specularium', new Date(2008, 09, 22), new Date() ],
					[ '1', 'NWS', new Date(2013, 07, 16), new Date() ]]);
