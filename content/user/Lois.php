...
<div class="span12 main-column">
	<h1><strong>Lois</strong> <small>3660</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Lois?></div>
		</div>
        
		<div class="span6">
            <h4>05 mei 2000</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/3660" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr>
		  <td><?=++$t;?></td>
		  <td><?=$LIF?></td>
		  <td><a href="http://forum.fok.nl/topic/8212" target="_blank">02 mar 2000</a></td>
		  <td>04 jun 2003</td>
		  <td><?=$uLois_i1;?> dagen</td>
		</tr>
		<tr class="success"> 
		  <td><?=++$t;?></td>
		...
		<tr>
		  ...
		  <td><code><?=$uLois_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 240px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'LIF', new Date(2000, 01, 12), new Date(2003, 05, 04) ],
					[ '2', 'OUD', new Date(2003, 03, 20), new Date()]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Lois', new Date(2000, 04, 05), new Date() ],
					[ '1', 'LIF', new Date(2000, 01, 12), new Date(2003, 05, 04) ],
					[ '2', 'OUD', new Date(2003, 03, 20), new Date()]]);
