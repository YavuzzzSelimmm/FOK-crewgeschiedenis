...
<div class="span12 main-column">
	<h1><strong>SiIk</strong> <small>349633</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_SiIk?></div>
		</div>
        
		<div class="span6">
            <h4>3 juli 2011</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/349633" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		...
		<tr>
		  ...
		  <td><code><?=$uSiIk_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'EXA', new Date(2013, 03, 01), new Date(2013, 06, 22) ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'SiIk', new Date(2011, 06, 03), new Date() ],
					[ '1', 'EXA', new Date(2013, 03, 01), new Date(2013, 06, 22) ]]);
