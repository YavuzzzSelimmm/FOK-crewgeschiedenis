...
<div class="span12 main-column">
	<h1><strong>Nibb-it</strong> <small>304498</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Nibbit?></div>
		</div>
        
		<div class="span6">
            <h4>25 mei 2010</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/304498" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1814362" target="_blank">09 mei 2012</a></td>
		  <td>heden</td>
		  <td><?=$uNibbit_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uNibbit_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 200px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'C&H', new Date(2012, 04, 09), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Nibb-it', new Date(2010, 04, 25), new Date() ],
					[ '1', 'C&H', new Date(2012, 04, 09), new Date() ]]);
