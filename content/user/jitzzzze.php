...
<div class="span12 main-column">
	<h1><strong>jitzzzze</strong> <small>39093</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_jitzzzze?></div>
		</div>
        
		<div class="span6">
            <h4>30 oktober 2002</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/39093" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1999538" target="_blank">23 jul 2013</a></td>
		  <td>heden</td>
		  <td><?=$ujitzzzze_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$ujitzzzze_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'DEF', new Date(2013, 06, 23), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'jitzzzze', new Date(2002, 09, 30), new Date() ],
					[ '1', 'DEF', new Date(2013, 06, 23), new Date() ]]);
