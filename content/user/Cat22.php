...
<div class="span12 main-column">
	<h1><strong>Cat22</strong> <small>161975</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Cat22?></div>
		</div>
        
		<div class="span6">
            <h4>17 november 2006</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/161975" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		...
		<tr>
		  ...
		  <td><code><?=$uCat22_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'FHF', new Date(2010, 09, 28), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Cat22', new Date(2006, 10, 17), new Date() ],
					[ '1', 'FHF', new Date(2010, 09, 28), new Date() ]]);
