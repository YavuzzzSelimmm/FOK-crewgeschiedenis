...
<div class="span12 main-column">
	<h1><strong>Mortaxx</strong> <small>206731</small></h1>
    <div class="row show-grid team-member">                                    
		<div class="spanUI photo">
			<div class="bordered-img"><?=$ui_Mortaxx?></div>
		</div>
        
		<div class="span6">
            <h4>20 februari 2008</h4>
            <p class="experience"><strong><a href="http://forum.fok.nl/user/profile/206731" target="blank_">FOK!profiel</a></strong></p>
			<br />
		</div>
	</div>
	...
	<table class="table table-striped">
	  ...
	  <tbody>
		<tr class="success">
		  ...
		  <td><a href="http://forum.fok.nl/topic/1929012" target="_blank">02 feb 2013</a></td>
		  <td>heden</td>
		  <td><?=$uMortaxx_i1;?> dagen</td>
		</tr>
		<tr>
		  <td></td>
		  <td></td>
		  ...
		  <td><code><?=$uMortaxx_total;?> dagen</code></td>
		</tr>
	  </tbody>
	</table>
		...
		<div class="tab-content" id="myTabContent" style="width: 100%; height: 225px;">		
			<div id="user" class="tab-pane fade active in">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					[ '1', 'KLB', new Date(2013, 01, 02), new Date() ]]);
			...
			<div id="fok" class="tab-pane fade">
				...
				function drawChart() {
				  ...
				  dataTable.addRows([
					...
					[ ' ', 'Mortaxx', new Date(2008, 01, 20), new Date() ],
					[ '1', 'KLB', new Date(2013, 01, 02), new Date() ]]);
